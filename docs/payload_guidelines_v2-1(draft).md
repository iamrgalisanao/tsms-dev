...
```json
{
  ...
  "transaction_count": 1,
  "payload_checksum": "4f7cc0ce6a7cc3e1d8dcf3deca6e54b2d42224dbbe53f0b1d248d41c10fc6a26",
  "transaction": {
...
FUNCTION Canonicalize(data):
    IF data IS Object (Associative Array / Map):
        ...
        2. FOR EACH key, value IN sorted_data:
            IF key IS "gross_sales", "net_sales", "receipt_no", OR "amount":
...
| **Note** | Currently requires the numeric internal `id`. Fetch this via the Status endpoint if unknown. |
...
```json
{
  ...
  "refund_reference_id": "REF-POS-998"
}
```
...
| Validation Status | Job Status | Meaning | POS Action |
| :--- | :--- | :--- | :--- |
