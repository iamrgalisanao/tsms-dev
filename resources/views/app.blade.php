                ...
                <div class="row mb-4">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <textarea id="textInput" class="form-control" rows="10" placeholder="Enter transaction data..."></textarea>
                    </div>
                    <button id="testButton" class="btn btn-primary mt-3">Test Parse</button>
                  </div>
                  <div class="col-md-6">
                    <h6>Test Results</h6>
                    <div id="testResults" class="border p-3 bg-light" style="min-height: 300px; max-height: 400px; overflow-y: auto;">
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    if (testButton) {
      testButton.addEventListener('click', function() {
        testResults.innerHTML = '<div class="spinner-border text-primary" role="status"><span class="visually-hidden">Loading...</span></div>';
